...
<form action="insert" method="get">
   <table>
    <tr><td>Name : <input type="text" name="name" id ="name" onkeypress="alphapeticOnly()"placeholder="Name"></td></tr>
    ...
    <tr><td>Father Name<input type="text" name="fatherName" onkeypress="alphapeticOnly() id="fatherName"></td></tr>
     <tr><td>Mother Name: <input type="text" name="motherName" onkeypress="alphapeticOnly() id="motherName"></td></tr>
